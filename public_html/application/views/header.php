			...
			<div class="row">
				...
				<div class="col-xs-8">
					<ul  id="Header_top_nav" class="nav navbar-nav navbar-left">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">NOTICE<br/><span>공지사항</span></a>
						...
						<li class="dropdown">
							<a href="/index.php/tutor_tuti_application/attendance.php" class="dropdown-toggle" data-toggle="dropdown">CLASS<br/><span>수업</span></a>
							<?if($this->session->userdata('login_data')!=NULL){?>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Q&A<br/><span>질의응답</span></a>
							<?if($this->session->userdata('login_data')!=NULL){?>
							<?if($login_data['grade']=='3'){
							?>
							<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">SUGGESTION<br/><span>제안</span></a>
							<?if($this->session->userdata('login_data')!=NULL){
							?>
							<?if($login_data['grade']=='3'){
							?>
						...
						<li  class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">ADMIN<br/><span>관리</span></a>
							<ul class="dropdown-menu">
								<li>
